    ...
    return (
        <div>
            <table>
                ...
                <h3>БМВ, «Байериш Моторен Верке», (BMW, Bayerisch Motoren Werke AG), немецкая автомобильная компания, специализирующаяся на производстве легковых и спортивных автомобилей, автомобилей повышенной проходимости и мотоциклов. Штаб-квартира находится в Мюнхене.
