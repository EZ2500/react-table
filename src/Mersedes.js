...
const Mersedes = (props) => {
    return ( 
        <div className='Mersedes'>
        <table>
<thead>
<title>Описание Mersedes-benz</title>
<style>
text-align: midlle;
</style>
</thead>
